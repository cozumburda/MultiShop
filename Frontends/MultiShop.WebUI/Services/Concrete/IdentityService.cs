...
namespace MultiShop.WebUI.Services.Concrete
{
    public class IdentityService : IIdentityService
    {
        ...
        {
            var discoverEndPoint = await _httpClient.GetDiscoveryDocumentAsync(new DiscoveryDocumentRequest
            {
            ...
            RefreshTokenRequest refreshTokenRequest = new()
            {
                ...
                Address = discoverEndPoint.TokenEndpoint
            };
        ...
        public async Task<bool> SingIn(SignInDto signInDto)
        {
            ...
            var userInfoRequest = new UserInfoRequest
            {
                ...
                Address = discoverEndPoint.UserInfoEndpoint
            };
